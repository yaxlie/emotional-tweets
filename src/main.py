...
parser.add_argument('-e', '--estimators', help='n-estimators for random forest classifier', type=int, default=100)
parser.add_argument('-c', '--clean', help='clean data', type=bool, default=False)

args = parser.parse_args()

if args.train_data:
    model, vectorizer = train(args.train_data, args.test, args.estimators)
